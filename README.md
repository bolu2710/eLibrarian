...
I have added some extra features that will help make the original software a bit easier for people who are not the best english speakers and also for people who like to always know where they are in the software.

I have added a text to speech function that tells the user where exactly in the program they are. The program will announce to them if they have reached the main menu, quit and so on.

I have also added a translator function that translates the function to spanish. So any other person who understands spanish will know how to get around the software.
