...
public class speech_create extends mainapp {
    ...
    public static void main(String[] args) {
        ...
        if (voice != null) {
            ...
            boolean status = voice.speak(" Welcome to Create Account.Follow the instructions below to make accounts. ENTER 'L' key to go back and login. ENTER 'C' key to continue. ");
